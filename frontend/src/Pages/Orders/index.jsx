                                          ...
                                          order?.products?.map((item, index) => {
                                            return (
                                              <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                ...
                                                <td className="px-6 py-4 font-[500]">{item?.price?.toLocaleString('ar-AE', { style: 'currency', currency: 'AED' })}</td>

                                                <td className="px-6 py-4 font-[500]">{(item?.price * item?.quantity)?.toLocaleString('ar-AE', { style: 'currency', currency: 'AED' })}</td>
                                              </tr>
                                            )
                                          })
                                        }
